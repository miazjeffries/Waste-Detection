...
output_csv = "data/processed/unified_class_data.csv"

image_types = {'.jpg', '.jpeg', '.png'}

# Standardized material classes that images will map to
material_classes = ['Glass', 'Paper', 'Cardboard', 'Plastic', 'Textile', 
                    'Metal', 'Organics', 'Ewaste', 'Other']
...
recyclable_and_household_waste_map = {'disposable_plastic_cutlery': 'Plastic',
                                      'food_waste': 'Organics', 
                                      'office_paper': 'Paper',
