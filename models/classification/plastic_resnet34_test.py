...
def main():
    ...
    checkpoint_path = os.path.join(Path(__file__).resolve().parent, "plastic_best_resnet34.pt")
    ...
    ''' SAVE RESULTS '''
    results_path = Path(__file__).resolve().parent / "plastic_resnet34_test_results.txt"
