...
def main():
    ...
    checkpoint_path = os.path.join(Path(__file__).resolve().parent, "best_efficientnetb0.pt")
    ...
    ''' SAVE RESULTS '''
    results_path = Path(__file__).resolve().parent / "efficientnetb0_test_results.txt"
