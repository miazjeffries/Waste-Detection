...
def main():
    ...
    model.fc = nn.Linear(model.fc.in_features, 10) # Replace last layer with 10 waste class outputs
    ...
    for epoch in range(25):
        ...
        if val_macro_f1 > best_val_f1:
            ...
            torch.save(model.state_dict(), "plastic_best_resnet34.pt")
