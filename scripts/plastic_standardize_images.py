...
input_csv = 'data/processed/plastic_split_data.csv'
output_dir = 'data/plastic_standardized_images'
output_csv = 'data/processed/plastic_standardized_split_data.csv'
target_size = (640, 640)
